...
1. Dans*Sécurité du cloud*, sélectionnez**Conformité réglementaire** parmi les éléments du menu de gauche.
  ...
  >Conseil du labo : si la page Conformité réglementaire affiche des données, veuillez**Actualiser** votre navigateur.
...
### Tâche 2 : Explorer la protection de charge de travail
